...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name", placeholder="E.g. Mahika Roy")
                ...
                if new_name:
                    with st.spinner('Creating your profile..'):
                        ...
                        if encodings:
                            ...
                            response_data = create_student(new_name, face_embedding=face_emb, voice_embeddings=voice_emb)
